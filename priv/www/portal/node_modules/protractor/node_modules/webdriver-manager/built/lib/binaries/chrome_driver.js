...
var ChromeDriver = (function (_super) {
    ...
    function ChromeDriver(alternateCDN) {
        var _this = _super.call(this, alternateCDN || config_1.Config.cdnUrls().chrome) || this;
        _this.name = 'chromedriver';
        _this.versionCustom = ChromeDriver.versionDefault;
        _this.prefixDefault = 'chromedriver_';
