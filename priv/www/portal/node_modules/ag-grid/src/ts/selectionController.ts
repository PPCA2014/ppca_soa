    ...
    private addCssClassForNode_andInformVirtualRowListener(node: any) {
        ...
        if (virtualRenderedRowIndex >= 0) {
            this.eParentsOfRows.forEach( function(rowContainer: HTMLElement) {
                _.querySelectorAll_addCssClass(rowContainer, '[row="' + virtualRenderedRowIndex + '"]', 'ag-row-selected');
            });
    ...
    private updateGroupParentsIfNeeded() {
        ...
        for (var rowIndex = firstRow; rowIndex <= lastRow; rowIndex++) {
            ...
            if (node.group) {
                ...
                this.eParentsOfRows.forEach( function(rowContainer: HTMLElement) {
                    if (selected) {
                        _.querySelectorAll_addCssClass(rowContainer, '[row="' + rowIndex + '"]', 'ag-row-selected');
                    } else {
                        _.querySelectorAll_removeCssClass(rowContainer, '[row="' + rowIndex + '"]', 'ag-row-selected');
                    }
                });
            }
        }
