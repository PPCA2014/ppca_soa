...
init(#service{datasource = Datasource, properties = Props}) ->
	...
	SqlLoadUsersTipoPessoa = binary_to_list(maps:get(<<"sql_load_users_tipo_pessoa">>, Props, <<>>)),
	SqlLoadUsersTipoAluno = binary_to_list(maps:get(<<"sql_load_users_tipo_aluno">>, Props, <<>>)),
	SqlUpdateUsersTipoPessoa = binary_to_list(maps:get(<<"sql_update_users_tipo_pessoa">>, Props, <<>>)),
	SqlUpdateUsersTipoAluno = binary_to_list(maps:get(<<"sql_update_users_tipo_aluno">>, Props, <<>>)),
