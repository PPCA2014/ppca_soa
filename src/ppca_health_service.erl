%%********************************************************************
%% @title Módulo ppca_health_service
%% @version 1.0.0
...
get_top_services(Request, _State) ->
	Top = list_to_integer(ppca_request:get_param_url(<<"top">>, "10", Request)),
	Periodo = ppca_request:get_querystring(<<"periodo">>, "year", Request),
	ppca_health:get_top_services(Top, Periodo).
