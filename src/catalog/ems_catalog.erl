...
list_kernel_catalog() ->
	gen_server:call(?SERVER, list_kernel_catalog).
...
handle_call(list_kernel_catalog, _From, State) ->
	Reply = do_list_kernel_catalog(State),
	{reply, Reply, State};
...
do_list_kernel_catalog(State) -> State#state.catk.
