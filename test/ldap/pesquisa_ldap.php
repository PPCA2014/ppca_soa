#!/usr/bin/php
#
# Program: pesquisa_ldap.sh
# Author: Everton de Vargas Agilar
# Data: 13/01/2016
#
# Modo de uso: $ ./pesquisa_ldap.sh server user. Ex.: ./pesquisa_ldap servicosssi.unb.br geral 
...
if($argc == 3){
	...
	die ('Modo de uso: ./pesquisa_ldap.sh server user. Ex.: ./pesquisa_ldap servicosssi.unb.br geral');
}


$ldapport		= 2389;
$ldappass   	= "123456";					 // senha do admin
...
echo "Pesquisando dados do usuário $ldapuser no banco BDAcesso.dbo.TB_Usuario\n";
